...
if($page==='reports' && can_report($u)){
    ...
    echo '<div class="panel"><h2>Export Laporan</h2><p class="muted">Karyawan hanya melihat report dirinya sendiri. Atasan melihat bawahannya. Admin HR dan Manajemen melihat seluruh data.</p><div class="actions"><a class="btn primary" href="?page=report_print" target="_blank">Download PDF</a><a class="btn ghost" href="?download=excel">Download Excel</a><a class="btn ghost" href="?download=csv">Download CSV</a></div></div>';
